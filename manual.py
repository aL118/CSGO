...
def main(save_name):
    ...
    folder_name = 'D:\\lyzheng\\projects\\angela\\Counter-Strike_Behavioural_Cloning\\playtest\\' #'F:/2021/csgo_bot_train_july2021/'
    ...
    print('starting loop, press X to quit...')
    while True:
        ...
        if SAVE_TRAIN_DATA and not IS_PAUSE:
            ...
            if 'X' in keys_pressed:
                file_name = folder_name+save_name+'.npy'# +'{}.npy'.format(starting_value)
